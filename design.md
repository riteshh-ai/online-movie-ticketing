...
Provide implementation-ready, token-driven UI guidance for QFX Cinemas so teams can ship web app interfaces that stay consistent, accessible, and fast to build.

    ...
    <section>
        <div class="container-fluid" style="overflow: hidden;"> <!-- Prevent scrolling -->
            <div class="row">
                ...
                <div class="col-md-10">
                    <h5 class="text-center mt-2" style="color:maroon;">Show Time Details </h5>
                    <a href="addshowtime.php" style="color:brown;">Add Show Time</a>
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td><a href="editshowtime.php?id=<?php echo $row["id"]; ?>" class="btn btn-primary">Edit</a>

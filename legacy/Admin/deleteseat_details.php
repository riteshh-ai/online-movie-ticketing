    ...
    <section>
        <div class="container-fluid" style="overflow: hidden;"> <!-- Prevent scrolling -->
            <div class="row">
                ...
                <div class="col-md-10">
                    <h5 class="text-center mt-2" style="color:maroon;">Delete Seat Details</h5>
                    ...
                    <div class="table-responsive mt-4">
                        <form method="post">
                            <div class="container" style="color: #343a40;">
                                ...
                                <input type="text" style="border-radius: 30px;" placeholder="Enter Seat Number" name="seat_no_txt" id="email" value="<?php echo $seat_no; ?>" disabled>

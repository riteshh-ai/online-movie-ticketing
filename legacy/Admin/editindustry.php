...
$name = "";
  ...
  if(isset($_POST["btn_update"])){
        ...
        $id = $_GET["id"];
        $conn = new connec();
        $sql = "update industry set industry_name='$name' where id=$id";
        $conn->update($sql, "Industry Updated Successfully");
    ...
    <section>
        <div class="container-fluid" style="overflow: hidden;"> <!-- Prevent scrolling -->
            <div class="row">
                ...
                <div class="col-md-10">
                    <h5 class="text-center mt-2" style="color:maroon;">Edit Industry Details</h5>
